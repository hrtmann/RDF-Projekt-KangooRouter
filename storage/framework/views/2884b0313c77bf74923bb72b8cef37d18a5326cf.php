...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card card-primary">
            ...
            <?php echo method_field('PATCH'); ?>
              ...
              <div class="form-group">
                  <label for="hardwareinterface_id">Hardware-Schnittstelle</label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /router/RouterRDF/resources/views/interfaces/edit.blade.php ENDPATH**/ ?>